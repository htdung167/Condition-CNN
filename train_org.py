...
#Loading data
train_df = pd.read_csv("./data/fashion_product_train.csv")
val_df = pd.read_csv("./data/fashion_product_validation.csv")
test_df = pd.read_csv("./data/fashion_product_test.csv")
